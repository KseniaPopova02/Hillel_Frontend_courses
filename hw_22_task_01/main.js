...
// Поля формы должны передаваться в виде объектов.
// Сами объекты-поля должны создаваться с помощью классов. Сделать хотя бы 3 вида инпутов с помощью классов (текст, чекбокс, селект).
// Общие свойства и методы выносить в родительский класс и обязательно использовать наследование.
